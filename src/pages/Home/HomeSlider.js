...
const HomeSlider = () => {
  return (
    <div className="carousel w-full rounded-3xl">
      <div
        id="slide1"
        className="carousel-item items-center bg-black relative w-full"
      >
        <div>
          <img src={featureMobileImg} alt="" />
        </div>
        <div>
          <h1 className="text-3xl font-bold">Short in budget?</h1>
          <p className="text-xl my-4">
            Looking for a compact Phone as secondary device?
          </p>
          <button className="btn btn-info btn-outline hidden md:block">Learn More</button>
        </div>
        <div className="absolute flex right-5 bottom-5 gap-2">
          <a href="#slide3" className="btn btn-circle btn-info btn-outline">
            ❮
          </a>
          <a href="#slide2" className="btn btn-circle btn-info btn-outline">
            ❯
          </a>
        </div>
      </div>
      ...
      >
        ...
        <div className="absolute flex right-5 bottom-5 gap-2">
          <a href="#slide1" className="btn btn-circle btn-info btn-outline">
            ❮
          </a>
          <a href="#slide3" className="btn btn-circle btn-info btn-outline">
            ❯
      ...
      <div id="slide3" className="carousel-item items-center bg-black relative w-full">
      <div>
